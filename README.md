...
Grab [a zip file from the releases](https://github.com/rBrenick/open-maya-file-in-blender/releases/download/0.00.03/open_maya_file_in_blender_0-00-03.zip), and install it as an Addon in Blender preferences. 
